...
from concrete import Weight,Container,Dosator,FlowMeter,Factory,Mixer,Manager,Readiness,Loaded,Transport
...
auger_1 = Container(m = lambda: cement_m_1.m, out=plc.AUGER_ON_1, max_sp=1000)
dcement_1 = Dosator(m = lambda: cement_m_1.m, out=plc.DCEMENT_OPEN_1, closed=plc.DCEMENT_CLOSED_1, containers=( auger_1,) )
# дозатор цемента #2. набор шнеком
auger_2 = Container(m = lambda: cement_m_2.m, out=plc.AUGER_ON_2, max_sp=1000)
dcement_2 = Dosator(m = lambda: cement_m_2.m, out=plc.DCEMENT_OPEN_2, closed=plc.DCEMENT_CLOSED_2, containers=( auger_2,) )
# дозатор цемента #3. набор шнеком
auger_3 = Container(m = lambda: cement_m_3.m, out=plc.AUGER_ON_3, max_sp=1000)
dcement_3 = Dosator(m = lambda: cement_m_3.m, out=plc.DCEMENT_OPEN_3, closed=plc.DCEMENT_CLOSED_3, containers=( auger_3,) )
...
water_1 = Container(m = lambda: water_m_1.m,out=wpumps_1.out,closed=wpumps_1.closed,max_sp=1000)
wpumps_1.container = water_1
dwater_1 = Dosator(m = lambda: water_m_1.m, out=plc.DWATER_OPEN_1, closed=plc.DWATER_CLOSED_1, containers=( water_1,) )
...
addition_1 = Container(m = lambda: addition_m_1.m, out=apumpvalve_1.out,closed=apumpvalve_1.closed, max_sp=10)
daddition_1 = Dosator(m = lambda: addition_m_1.m, out=plc.DADDITION_OPEN_1, closed=plc.DADDITION_CLOSED_1, containers=( addition_1,) )
...
addition_2 = Container(m = lambda: addition_m_2.m, out=apumpvalve_2.out,closed=apumpvalve_2.closed, max_sp=10)
daddition_2 = Dosator(m = lambda: addition_m_2.m, out=plc.DADDITION_OPEN_2, closed=plc.DADDITION_CLOSED_2, containers=( addition_2,) )
...
addition_3 = Container(m = lambda: addition_m_3.m, out=apumpvalve_3.out,closed=apumpvalve_3.closed, max_sp=10)
apumpvalve_3.container = addition_3
daddition_3 = Dosator(m = lambda: addition_m_3.m, out=plc.DADDITION_OPEN_3, closed=plc.DADDITION_CLOSED_3, containers=( addition_3,) )
...
addition_4 = Container(m = lambda: addition_m_4.m, out=apumpvalve_4.out, closed=apumpvalve_4.closed, max_sp=10)
daddition_4 = Dosator(m = lambda: addition_m_4.m, out=plc.DADDITION_OPEN_4, closed=plc.DADDITION_CLOSED_4, containers=( addition_4,) )
...
addition_5 = Container(m = lambda: addition_m_5.m, out=apumpvalve_5.out,closed=apumpvalve_5.closed, max_sp=10)
daddition_5 = Dosator(m = lambda: addition_m_5.m, out=plc.DADDITION_OPEN_5, closed=plc.DADDITION_CLOSED_5, containers=( addition_5,) )
...
addition_6 = Container(m = lambda: addition_m_6.m, out=apumpvalve_6.out,closed=apumpvalve_6.closed, max_sp=10)
daddition_6 = Dosator(m = lambda: addition_m_6.m, out=plc.DADDITION_OPEN_6, closed=plc.DADDITION_CLOSED_6, containers=( addition_6,) )
...
addition_7 = Container(m = lambda: addition_m_7.m, out=apumpvalve_7.out,closed=apumpvalve_7.closed, max_sp=10)
daddition_7 = Dosator(m = lambda: addition_m_7.m, out=plc.DADDITION_OPEN_7, closed=plc.DADDITION_CLOSED_7, containers=( addition_7,) )
...
daddition_8 = ManualDosator( level = plc.DADDITION_ISEMPTY_8, out=plc.DADDITION_OPEN_8, closed=plc.DADDITION_CLOSED_8,containers=(addition_8,) )
...
daddition_9 = ManualDosator( level = plc.DADDITION_ISEMPTY_9, out=plc.DADDITION_OPEN_9, closed=plc.DADDITION_CLOSED_9,containers=(addition_9,) )
...
daddition_10 = ManualDosator( level = plc.DADDITION_ISEMPTY_10, out=plc.DADDITION_OPEN_10, closed=plc.DADDITION_CLOSED_10,containers=(addition_10,) )
...
mcontainer_1 = ManualDosator( closed=plc.MC_CLOSED_1, out=plc.MC_OPEN_1,helper=plc.MC_VIBRATOR_ON_1)
...
ready_1 = Readiness(rails=(dcement_1, dcement_2,dcement_3,dwater_1,daddition_1,daddition_2,daddition_3,daddition_4,daddition_5,daddition_6,daddition_7,daddition_8,daddition_9,daddition_10) )
loaded_1 = Loaded( rails=(dcement_1, dcement_2,dcement_3,dwater_1,daddition_1,daddition_2,daddition_3,daddition_4,daddition_5,daddition_6,daddition_7,daddition_8,daddition_9,daddition_10) )
manager_1 = Manager(collected=ready_1,loaded=loaded_1, mixer=mixer_1, dosators=(dcement_1,dcement_2,dcement_3,dwater_1,daddition_1,daddition_2,daddition_3,daddition_4,daddition_5,daddition_6,daddition_7,daddition_8,daddition_9,daddition_10) )

factory_1.on_emergency = tuple( x.emergency for x in (dcement_1, dcement_2, dcement_3, dwater_1, daddition_1,daddition_2,daddition_3,daddition_4,daddition_5,daddition_6,daddition_7,daddition_8,daddition_9,daddition_10, mixer_1,manager_1,water_1) )
factory_1.on_mode = tuple( x.switch_mode for x in (dcement_1, dcement_2, dcement_3, dwater_1, daddition_1,daddition_2,daddition_3,daddition_4,daddition_5,daddition_6,daddition_7,daddition_8,daddition_9,daddition_10) )

instances = ( cement_m_1,cement_m_2,cement_m_3,
              water_m_1,
              addition_m_1,addition_m_2,addition_m_3,addition_m_4,addition_m_5,addition_m_6,addition_m_7,
              auger_1,auger_2,auger_3,
              water_1,
              ...
              wpumps_1,
              factory_1,gate_1,motor_1,mixer_1,
...
if platform=="linux":
  ...
  imcontainer_1 = iVALVE(open=plc.MC_OPEN_1,closed=plc.MC_CLOSED_1)
